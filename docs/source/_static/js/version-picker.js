document.addEventListener("DOMContentLoaded", function () {
  ...
  versionPicker.style.bottom = "20px";
  versionPicker.style.right = "20px";
  versionPicker.style.backgroundColor = "#ffffff";
  versionPicker.style.border = "1px solid #ddd";
  versionPicker.style.padding = "10px";
  ...
  versions.forEach(version => {
    ...
    if (window.location.pathname.startsWith(version.url)) {
