...
````{py:method} regex_register(re_url: str, handler: typing.Callable, name: typing.Optional[str] = None, methods: typing.Optional[typing.List[str]] = None) -> None
...
````{py:method} register(url_path: str, handler: typing.Callable, name: typing.Optional[str] = None, methods: typing.Optional[typing.List[str]] = None) -> None
