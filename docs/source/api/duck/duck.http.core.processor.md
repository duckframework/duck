...
````{py:method} process_view_decorators()
:canonical: duck.http.core.processor.RequestProcessor.process_view_decorators

```{autodocx-docstring} duck.http.core.processor.RequestProcessor.process_view_decorators
```
