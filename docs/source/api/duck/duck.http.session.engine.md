...
````{py:method} _save()
:canonical: duck.http.session.engine.SessionStore._save

```{autodocx-docstring} duck.http.session.engine.SessionStore._save
```

````

````{py:method} assign_new_session_key() -> str
:canonical: duck.http.session.engine.SessionStore.assign_new_session_key

```{autodocx-docstring} duck.http.session.engine.SessionStore.assign_new_session_key
```

````

````{py:method} async_save()
:canonical: duck.http.session.engine.SessionStore.async_save
:async:

```{autodocx-docstring} duck.http.session.engine.SessionStore.async_save
```
...
````{py:method} ensure_session_loaded(method)
:canonical: duck.http.session.engine.SessionStore.ensure_session_loaded
:staticmethod:

```{autodocx-docstring} duck.http.session.engine.SessionStore.ensure_session_loaded
```
...
````{py:method} get(*args, **kw)
:canonical: duck.http.session.engine.SessionStore.get

```{autodocx-docstring} duck.http.session.engine.SessionStore.get
```
...
````{py:property} loaded
:canonical: duck.http.session.engine.SessionStore.loaded
:type: bool

```{autodocx-docstring} duck.http.session.engine.SessionStore.loaded
```
...
````{py:method} session_expired() -> bool
:canonical: duck.http.session.engine.SessionStore.session_expired

```{autodocx-docstring} duck.http.session.engine.SessionStore.session_expired
```
