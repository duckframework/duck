...
````{py:method} geturl(absolute=True)
:canonical: duck.http.fileuploads.handlers.BaseFileUpload.geturl

```{autodocx-docstring} duck.http.fileuploads.handlers.BaseFileUpload.geturl
```
...
````{py:method} normalize_filename() -> str
:canonical: duck.http.fileuploads.handlers.BaseFileUpload.normalize_filename

```{autodocx-docstring} duck.http.fileuploads.handlers.BaseFileUpload.normalize_filename
```
