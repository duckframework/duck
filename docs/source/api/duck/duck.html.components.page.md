...
````{py:method} set_favicon(source: str, icon_type: str = 'image/png', rel: str = 'icon', sizes: typing.Optional[str] = None) -> duck.html.components.NoInnerComponent
...
````{py:method} set_meta(name: str, content: str) -> duck.html.components.NoInnerComponent
:canonical: duck.html.components.page.Page.set_meta

```{autodocx-docstring} duck.html.components.page.Page.set_meta
```
