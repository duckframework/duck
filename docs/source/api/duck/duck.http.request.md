...
````{py:method} _set_request_fields_and_finalize()
:canonical: duck.http.request.Request._set_request_fields_and_finalize

```{autodocx-docstring} duck.http.request.Request._set_request_fields_and_finalize
```
...
````{py:method} extract_auth_from_request(request: duck.http.request.Request) -> typing.Dict[str, str]
...
````{py:method} extract_content_queries(request: duck.http.request.Request) -> typing.Dict
...
````{py:method} extract_files_from_request(request: duck.http.request.Request) -> typing.Tuple[typing.Dict, typing.Dict]
:canonical: duck.http.request.Request.extract_files_from_request
:staticmethod:

```{autodocx-docstring} duck.http.request.Request.extract_files_from_request
```

````

````{py:method} extract_url_queries(url: str) -> duck.http.querydict.QueryDict
