...
````{py:method} _check_update_targets(targets: set, min_shared_parent_detections: int = 3) -> None
:canonical: duck.html.components.HtmlComponent._check_update_targets

```{autodocx-docstring} duck.html.components.HtmlComponent._check_update_targets
```
...
````{py:method} assign_component_uids(root_component: duck.html.components.Component, base_uid: str = '0', force: bool = False) -> None
...
````{py:method} async_load()
:canonical: duck.html.components.HtmlComponent.async_load
:async:

```{autodocx-docstring} duck.html.components.HtmlComponent.async_load
```

````

````{py:method} async_render() -> str
:canonical: duck.html.components.HtmlComponent.async_render
:async:

```{autodocx-docstring} duck.html.components.HtmlComponent.async_render
```

````

````{py:method} async_to_vdom() -> duck.html.components.core.vdom.VDomNode
:canonical: duck.html.components.HtmlComponent.async_to_vdom
:async:

```{autodocx-docstring} duck.html.components.HtmlComponent.async_to_vdom
```
