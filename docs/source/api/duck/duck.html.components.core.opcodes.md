...
````{py:attribute} SYNC_BROWSER_STATE
:canonical: duck.html.components.core.opcodes.EventOpCode.SYNC_BROWSER_STATE
:value: >
   170

```{autodocx-docstring} duck.html.components.core.opcodes.EventOpCode.SYNC_BROWSER_STATE
```
