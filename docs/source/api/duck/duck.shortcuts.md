...
* - {py:obj}`media <duck.shortcuts.media>`
  - ```{autodocx-docstring} duck.shortcuts.media
    :summary:
    ```
* - {py:obj}`media_filepath <duck.shortcuts.media_filepath>`
  - ```{autodocx-docstring} duck.shortcuts.media_filepath
    :summary:
    ```
...
* - {py:obj}`static <duck.shortcuts.static>`
  - ```{autodocx-docstring} duck.shortcuts.static
    :summary:
    ```
* - {py:obj}`static_filepath <duck.shortcuts.static_filepath>`
  - ```{autodocx-docstring} duck.shortcuts.static_filepath
    :summary:
    ```
...
````{py:function} media(resource_path: str, absolute: bool = True) -> str
...
````{py:function} media_filepath(relative_filepath: str) -> str
:canonical: duck.shortcuts.media_filepath
...
````{py:function} static(resource_path: str, absolute: bool = True) -> str
...
````{py:function} static_filepath(relative_filepath: str, blueprint: typing.Optional[duck.routes.Blueprint] = None, target_static_dir: typing.Optional[str] = None) -> str
:canonical: duck.shortcuts.static_filepath
