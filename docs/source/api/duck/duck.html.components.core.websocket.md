...
````{py:method} build_navigation_request(root_request, fullpath: str, headers: typing.Dict[str, str]) -> duck.http.request.HttpRequest
:canonical: duck.html.components.core.websocket.EventHandler.build_navigation_request

```{autodocx-docstring} duck.html.components.core.websocket.EventHandler.build_navigation_request
```
...
````{py:method} ensure_browser_state_synced(root_request: duck.http.request.HttpRequest)
:canonical: duck.html.components.core.websocket.EventHandler.ensure_browser_state_synced
:async:

```{autodocx-docstring} duck.html.components.core.websocket.EventHandler.ensure_browser_state_synced
```
...
````{py:method} update_now(component, updates: typing.List[str])
:canonical: duck.html.components.core.websocket.LivelyWebSocketView.update_now
:async:

```{autodocx-docstring} duck.html.components.core.websocket.LivelyWebSocketView.update_now
```
