...
`````{py:class} Email(smtp_host: str, smtp_port: int, username: str, password: str, from_addr: str, name: str, to: str, subject: str, body: str, recipients: typing.Optional[typing.List[str]] = None, use_bcc: bool = True, use_ssl: bool = True, reply_to: typing.Optional[str] = None)
...
````{py:class} Gmail(username: str, password: str, from_addr: str, name: str, to: str, subject: str, body: str, recipients: typing.Optional[typing.List[str]] = None, use_bcc: bool = True, use_ssl: bool = True, reply_to: typing.Optional[str] = None)
