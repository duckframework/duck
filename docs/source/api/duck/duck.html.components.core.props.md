...
* - {py:obj}`_sentinel <duck.html.components.core.props._sentinel>`
  - ```{autodocx-docstring} duck.html.components.core.props._sentinel
    :summary:
    ```
````
...
````{py:method} pop(key: str, default: typing.Any = _sentinel) -> typing.Any
...
````{py:data} _sentinel
:canonical: duck.html.components.core.props._sentinel
:value: >
   'object(...)'
