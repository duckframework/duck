...
* - {py:obj}`in_async_context <duck.utils.asyncio.in_async_context>`
  - ```{autodocx-docstring} duck.utils.asyncio.in_async_context
    :summary:
    ```
* - {py:obj}`raise_if_in_async_context <duck.utils.asyncio.raise_if_in_async_context>`
  - ```{autodocx-docstring} duck.utils.asyncio.raise_if_in_async_context
    :summary:
    ```
````
...
````{py:function} raise_if_in_async_context(message)
:canonical: duck.utils.asyncio.raise_if_in_async_context
