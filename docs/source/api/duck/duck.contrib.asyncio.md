...
````{py:function} get_available_event_loop(id: typing.Optional[str] = None) -> asyncio.AbstractEventLoop
...
````{py:function} run_on_available_loop(coro: typing.Coroutine, id: typing.Optional[str] = None, return_sync_future: bool = False) -> typing.Union[duck.utils.asyncio.eventloop.SyncFuture, asyncio.Future]
